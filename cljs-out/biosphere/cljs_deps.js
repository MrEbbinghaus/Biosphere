...
goog.addDependency("../biosphere/utils.js", ['biosphere.utils'], ['cljs.core', 'quil.core']);
goog.addDependency("../biosphere/protocols.js", ['biosphere.protocols'], ['cljs.core']);
goog.addDependency("../biosphere/tiles.js", ['biosphere.tiles'], ['biosphere.protocols', 'cljs.core']);
...
goog.addDependency("../biosphere/config.js", ['biosphere.config'], ['cljs.core']);
goog.addDependency("../biosphere/draw/tile.js", ['biosphere.draw.tile'], ['cljs.core', 'biosphere.tiles', 'quil.core']);
goog.addDependency("../biosphere/creature.js", ['biosphere.creature'], ['biosphere.utils', 'cljs.core', 'biosphere.tiles', 'quil.core', 'biosphere.config']);
goog.addDependency("../biosphere/draw/creature.js", ['biosphere.draw.creature'], ['biosphere.utils', 'cljs.core', 'quil.core', 'biosphere.creature']);
goog.addDependency("../biosphere/draw/core.js", ['biosphere.draw.core'], ['cljs.core', 'quil.core', 'biosphere.draw.tile', 'biosphere.draw.creature']);
goog.addDependency("../biosphere/core.js", ['biosphere.core'], ['biosphere.utils', 'goog.Uri', 'cljs.core', 'biosphere.tiles', 'quil.core', 'quil.middleware', 'biosphere.config', 'biosphere.draw.core', 'biosphere.draw.tile', 'biosphere.creature', 'clojure.string', 'biosphere.draw.creature']);
