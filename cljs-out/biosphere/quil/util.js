...
var or__4185__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12442_SHARP_){
return p1__12442_SHARP_.length();
}),cljs.core.keys(m))));
...
return cljs.core.dorun.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__12446){
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12450_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__12450_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["PConstants/",quil.util.prepare_quil_name(p1__12450_SHARP_)].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12451_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__12451_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,cljs.core.cst$sym$cljs$core_SLASH_aget,null,(1),null)),(new cljs.core.List(null,cljs.core.cst$sym$js_SLASH_p5$prototype,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,quil.util.prepare_quil_name(p1__12451_SHARP_),null,(1),null))], 0))))],null));
}),constants));
});
...
var ret__4835__auto___12457 = (function (){
quil.util.generate_quil_constants = (function quil$util$generate_quil_constants(var_args){
var args__4795__auto__ = [];
var len__4789__auto___12458 = arguments.length;
var i__4790__auto___12459 = (0);
while(true){
if((i__4790__auto___12459 < len__4789__auto___12458)){
args__4795__auto__.push((arguments[i__4790__auto___12459]));

var G__12460 = (i__4790__auto___12459 + (1));
i__4790__auto___12459 = G__12460;
continue;
} else {
}
break;
...
return quil.util.generate_quil_constants.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),argseq__4796__auto__);
});
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,cljs.core.cst$sym$do,null,(1),null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12452_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__12452_SHARP_),cljs.core.second(p1__12452_SHARP_));
...
/** @this {Function} */
(quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq12453){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12454,G__12455,G__12456,seq12453__$3);
}));
