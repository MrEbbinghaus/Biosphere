...
var sablono$util$ToString$to_str$dyn_19122 = (function (x){
...
return sablono$util$ToString$to_str$dyn_19122.call(null,x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_19123 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_19123.call(null,x);
}
});
...
var len__4736__auto___19125 = arguments.length;
var i__4737__auto___19126 = (0);
while(true){
if((i__4737__auto___19126 < len__4736__auto___19125)){
args__4742__auto__.push((arguments[i__4737__auto___19126]));

var G__19127 = (i__4737__auto___19126 + (1));
i__4737__auto___19126 = G__19127;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq19124){
...
var vec__19128 = cljs.core.name.call(null,k).split("-");
...
var first_word = first__19130;
var words = seq__19129__$1;
...
var m__$1 = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__19131){
...
return cljs.core.update.call(null,G__19135,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__19135;
}
} else {
