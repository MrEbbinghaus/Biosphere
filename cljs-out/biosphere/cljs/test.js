...
var G__22178 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__22178,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__22178;
}
}));
...
var len__4736__auto___22183 = arguments.length;
var i__4737__auto___22184 = (0);
while(true){
if((i__4737__auto___22184 < len__4736__auto___22183)){
args__4742__auto__.push((arguments[i__4737__auto___22184]));

var G__22185 = (i__4737__auto___22184 + (1));
i__4737__auto___22184 = G__22185;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq22180){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22181,G__22182,seq22180__$2);
}));
...
var file = cljs.core.get.call(null,map__22187__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__22187__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__22187__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__22186_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__22186_SHARP_));
...
var temp__5735__auto___22189 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___22189)){
var message_22190 = temp__5735__auto___22189;
cljs.core.println.call(null,message_22190);
} else {
}
...
var temp__5735__auto___22191 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___22191)){
var message_22192 = temp__5735__auto___22191;
cljs.core.println.call(null,message_22192);
} else {
}
...
var output_dir = "target/public/cljs-out/biosphere";
var output_dir__$1 = (function (){var G__22193 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__22193,"/"].join('');
} else {
return G__22193;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__22195 = exception.stack;
var G__22195__$1 = (((G__22195 == null))?null:clojure.string.split_lines.call(null,G__22195));
var G__22195__$2 = (((G__22195__$1 == null))?null:cljs.core.get.call(null,G__22195__$1,depth));
if((G__22195__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__22195__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__22196 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__22196,(0),null);
var column = cljs.core.nth.call(null,vec__22196,(1),null);
var vec__22199 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__22199,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__22199,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__22199,(2),null);
...
var m__$1 = (function (){var G__22202 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__22206 = (function (){var G__22205 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__22205);
} else {
return G__22205;
}
})();
...
return cljs.core.vary_meta.call(null,G__22207,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__22211 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__22211,(0),null);
var types = vec__22211;
...
return cljs.core.map.call(null,(function (p__22214){
var vec__22215 = p__22214;
var ns = cljs.core.nth.call(null,vec__22215,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__22215,(1),null);
return (function (){
...
var G__22218 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__22219 = cljs.core.seq.call(null,vars__$1);
var chunk__22220 = null;
var count__22221 = (0);
var i__22222 = (0);
while(true){
if((i__22222 < count__22221)){
var v = cljs.core._nth.call(null,chunk__22220,i__22222);
var temp__5735__auto___22224 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___22224)){
var t_22225 = temp__5735__auto___22224;
each_fixture_fn.call(null,((function (seq__22219,chunk__22220,count__22221,i__22222,t_22225,temp__5735__auto___22224,v,each_fixture_fn,G__22218,G__22218__$1,env,once_fixtures,each_fixtures,vec__22215,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22225)));
});})(seq__22219,chunk__22220,count__22221,i__22222,t_22225,temp__5735__auto___22224,v,each_fixture_fn,G__22218,G__22218__$1,env,once_fixtures,each_fixtures,vec__22215,ns,vars__$1))
);
} else {
}


var G__22226 = seq__22219;
var G__22227 = chunk__22220;
var G__22228 = count__22221;
var G__22229 = (i__22222 + (1));
seq__22219 = G__22226;
chunk__22220 = G__22227;
count__22221 = G__22228;
i__22222 = G__22229;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__22219);
if(temp__5735__auto__){
var seq__22219__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__22219__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__22219__$1);
var G__22230 = cljs.core.chunk_rest.call(null,seq__22219__$1);
var G__22231 = c__4556__auto__;
var G__22232 = cljs.core.count.call(null,c__4556__auto__);
var G__22233 = (0);
seq__22219 = G__22230;
chunk__22220 = G__22231;
count__22221 = G__22232;
i__22222 = G__22233;
continue;
} else {
var v = cljs.core.first.call(null,seq__22219__$1);
var temp__5735__auto___22234__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___22234__$1)){
var t_22235 = temp__5735__auto___22234__$1;
each_fixture_fn.call(null,((function (seq__22219,chunk__22220,count__22221,i__22222,t_22235,temp__5735__auto___22234__$1,v,seq__22219__$1,temp__5735__auto__,each_fixture_fn,G__22218,G__22218__$1,env,once_fixtures,each_fixtures,vec__22215,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22235)));
});})(seq__22219,chunk__22220,count__22221,i__22222,t_22235,temp__5735__auto___22234__$1,v,seq__22219__$1,temp__5735__auto__,each_fixture_fn,G__22218,G__22218__$1,env,once_fixtures,each_fixtures,vec__22215,ns,vars__$1))
);
} else {
}


var G__22236 = cljs.core.next.call(null,seq__22219__$1);
var G__22237 = null;
var G__22238 = (0);
var G__22239 = (0);
seq__22219 = G__22236;
chunk__22220 = G__22237;
count__22221 = G__22238;
i__22222 = G__22239;
continue;
}
} else {
