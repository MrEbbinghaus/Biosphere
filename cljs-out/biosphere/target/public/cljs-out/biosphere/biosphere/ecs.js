...
(biosphere.ecs.Position.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k10522,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k10522,else__4442__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4461__auto__,p__10527){
var vec__10528 = p__10527;
var k__4462__auto__ = cljs.core.nth.call(null,vec__10528,(0),null);
var v__4463__auto__ = cljs.core.nth.call(null,vec__10528,(1),null);
...
(biosphere.ecs.Position.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__10521){
var self__ = this;
var G__10521__$1 = this;
return (new cljs.core.RecordIter((0),G__10521__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"r","r",-471384190),new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(biosphere.ecs.Position.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this10523,other10524){
var self__ = this;
var this10523__$1 = this;
return (((!((other10524 == null)))) && ((this10523__$1.constructor === other10524.constructor)) && (cljs.core._EQ_.call(null,this10523__$1.x,other10524.x)) && (cljs.core._EQ_.call(null,this10523__$1.y,other10524.y)) && (cljs.core._EQ_.call(null,this10523__$1.r,other10524.r)) && (cljs.core._EQ_.call(null,this10523__$1.s,other10524.s)) && (cljs.core._EQ_.call(null,this10523__$1.__extmap,other10524.__extmap)));
}));
...
(biosphere.ecs.Position.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__10521){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__10531 = cljs.core.keyword_identical_QMARK_;
var expr__10532 = k__4447__auto__;
if(cljs.core.truth_(pred__10531.call(null,new cljs.core.Keyword(null,"x","x",2099068185),expr__10532))){
return (new biosphere.ecs.Position(G__10521,self__.y,self__.r,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10531.call(null,new cljs.core.Keyword(null,"y","y",-1757859776),expr__10532))){
return (new biosphere.ecs.Position(self__.x,G__10521,self__.r,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10531.call(null,new cljs.core.Keyword(null,"r","r",-471384190),expr__10532))){
return (new biosphere.ecs.Position(self__.x,self__.y,G__10521,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__10531.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__10532))){
return (new biosphere.ecs.Position(self__.x,self__.y,self__.r,G__10521,self__.__meta,self__.__extmap,null));
} else {
return (new biosphere.ecs.Position(self__.x,self__.y,self__.r,self__.s,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4447__auto__,G__10521),null));
}
}
}
}
...
(biosphere.ecs.Position.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__10521){
var self__ = this;
var this__4438__auto____$1 = this;
return (new biosphere.ecs.Position(self__.x,self__.y,self__.r,self__.s,G__10521,self__.__extmap,self__.__hash));
}));
 ...
 */
biosphere.ecs.map__GT_Position = (function biosphere$ecs$map__GT_Position(G__10525){
var extmap__4478__auto__ = (function (){var G__10534 = cljs.core.dissoc.call(null,G__10525,new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"r","r",-471384190),new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_.call(null,G__10525)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__10534);
} else {
return G__10534;
}
})();
return (new biosphere.ecs.Position(new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(G__10525),new cljs.core.Keyword(null,"y","y",-1757859776).cljs$core$IFn$_invoke$arity$1(G__10525),new cljs.core.Keyword(null,"r","r",-471384190).cljs$core$IFn$_invoke$arity$1(G__10525),new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__10525),null,cljs.core.not_empty.call(null,extmap__4478__auto__),null));
});

var e_10536 = brute.entity.create_entity.call(null);
brute.entity.add_entity.call(null,biosphere.ecs.system,e_10536);

brute.entity.add_component.call(null,biosphere.ecs.system,e_10536,(new biosphere.ecs.Position((1),(2),(180),(1),null,null,null)));
