...
var o25155 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25155["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25156 = temp__5733__auto____$1;
return (o25156["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24061__auto__ = f;
return (o__24061__auto__["toString"]).call(o__24061__auto__);
} else {
return "";
}
...
try{var o__24061__auto___25159 = t;
(o__24061__auto___25159["cljs$lang$ctorPrWriter"]).call(o__24061__auto___25159,t,writer);
}catch (e25158){var __25160 = e25158;
}
...
var char_code = (function (){var o__24061__auto__ = (new String(char$));
return (o__24061__auto__["charCodeAt"]).call(o__24061__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24061__auto__ = String;
return (o__24061__auto__["fromCharCode"]).call(o__24061__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25161 = num_code;
switch (G__25161) {
case (1):
return (185);
...
var o__24061__auto__ = String;
return (o__24061__auto__["fromCharCode"]).call(o__24061__auto__,superscript_code);
});
/**
...
}catch (e25163){var _e__24068__auto__ = e25163;
return false;
}})())){
...
var vec__25164 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25164,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o25167 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25167["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25168 = temp__5733__auto____$1;
return (o25168["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25171){
var vec__25172 = p__25171;
var ns_detector = cljs.core.nth.call(null,vec__25172,(0),null);
...
var G__25178 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25179 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25178;
remaining_tokens = G__25179;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25169){
var G__25170 = cljs.core.first.call(null,seq25169);
var seq25169__$1 = cljs.core.next.call(null,seq25169);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25170,seq25169__$1);
}));
...
var vec__25183 = cljs.core.split_with.call(null,(function (p1__25182_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25182_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25183,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25183,(1),null);
...
var vec__25189 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25189,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25189,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25192 = cljs.core.rest.call(null,remaining_tokens);
var G__25193 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25192;
name_tokens = G__25193;
continue;
} else {
...
var vec__25196 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25196,(0),null);
var arity = cljs.core.nth.call(null,vec__25196,(1),null);
var vec__25199 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25199,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25199,(1),null);
var vec__25202 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25202,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25202,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25202,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25202,(3),null);
...
var vec__25208 = result;
var munged_ns = cljs.core.nth.call(null,vec__25208,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25208,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25208,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25208,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25208,(4),null);
var arity = cljs.core.nth.call(null,vec__25208,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__25212 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__25212,(0),null);
var args = cljs.core.nth.call(null,vec__25212,(1),null);
var vec__25215 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25215,(0),null);
var name = cljs.core.nth.call(null,vec__25215,(1),null);
...
var G__25218 = (arity + (1));
var G__25219 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25220){
var vec__25221 = p__25220;
var arity = cljs.core.nth.call(null,vec__25221,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25221,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25224_SHARP_){
return cljs.core.get.call(null,arities,p1__25224_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25225_SHARP_){
return cljs.core.drop.call(null,(2),p1__25225_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25228){
var vec__25229 = p__25228;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25229,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25226){
...
var map__25237__$1 = (((((!((map__25237 == null))))?(((((map__25237.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25237.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25237):map__25237);
var include_ns_QMARK_ = cljs.core.get.call(null,map__25237__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25237__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25237__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25237__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25238 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25238,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25238,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25238,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25238,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25238,(4),null);
var arity = cljs.core.nth.call(null,vec__25238,(5),null);
...
var o__24061__auto__ = f;
return (o__24061__auto__["getBasis"]).call(o__24061__auto__);
});
/**
...
}catch (e25242){var _e__24068__auto__ = e25242;
...
var G__25243 = (obj[cljs.core.first.call(null,path)]);
var G__25244 = cljs.core.rest.call(null,path);
obj = G__25243;
path = G__25244;
continue;
} else {
...
var _STAR_ = (function (accum,p__25245){
var vec__25246 = p__25245;
var bit = cljs.core.nth.call(null,vec__25246,(0),null);
var protocol = cljs.core.nth.call(null,vec__25246,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25249){
var vec__25250 = p__25249;
var ns = cljs.core.nth.call(null,vec__25250,(0),null);
var name = cljs.core.nth.call(null,vec__25250,(1),null);
var selector = cljs.core.nth.call(null,vec__25250,(2),null);
...
var post_process = (function (p__25254){
var vec__25255 = p__25254;
var munged_name = cljs.core.nth.call(null,vec__25255,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25255,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25253_SHARP_){
return (obj[cljs.core.first.call(null,p1__25253_SHARP_)]);
}),sorted_matches);
