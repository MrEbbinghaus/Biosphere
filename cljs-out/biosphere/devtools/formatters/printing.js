...
var len__4736__auto___25335 = arguments.length;
var i__4737__auto___25336 = (0);
while(true){
if((i__4737__auto___25336 < len__4736__auto___25335)){
args__4742__auto__.push((arguments[i__4737__auto___25336]));

var G__25337 = (i__4737__auto___25336 + (1));
i__4737__auto___25336 = G__25337;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25332){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25333,G__25334,seq25332__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25338_SHARP_){
return (!((cljs.core.meta.call(null,p1__25338_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__25339__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25343){var _e__24068__auto__ = e25343;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e25345){var _e__24068__auto__ = e25345;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25347 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25348 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25348);

try{var map__25349 = opts;
var map__25349__$1 = (((((!((map__25349 == null))))?(((((map__25349.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25349.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25349):map__25349);
var markup_db = cljs.core.get.call(null,map__25349__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25347);
}});
...
var temp__5733__auto___25354 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___25354)){
var managed_print_level_25355 = temp__5733__auto___25354;
var _STAR_print_level_STAR__orig_val__25352_25356 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25353_25357 = managed_print_level_25355;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25353_25357);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__25351_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__25351_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25352_25356);
}} else {
job_fn.call(null);
}
