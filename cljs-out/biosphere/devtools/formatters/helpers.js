...
var G__25278 = devtools.prefs.pref.call(null,v);
v = G__25278;
continue;
} else {
return v;
...
}catch (e25281){var _e__24068__auto__ = e25281;
return false;
}})();
...
}catch (e25285){var _e__24068__auto__ = e25285;
return false;
}})();
...
}catch (e25287){var _e__24068__auto__ = e25287;
return false;
}}
}
});
...
var vec__25289 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25289,(0),null);
var name = cljs.core.nth.call(null,vec__25289,(1),null);
...
return cljs.core.some.call(null,(function (p1__25292_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25292_SHARP_);
}),template);
});
